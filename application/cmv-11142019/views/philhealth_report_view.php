                                ...
                                <div class="panel-inside">
                                    <div class="panel-inside1">
                                        <div class="panel-heading emp-panel-header">
                                            <h2 style="font-weight:300;">PHILHEALTH Report </h2>
                                            <span style="float: right;">
                                            <button type="button" class="btn btn-default btn-report padding5" id="print_philhealth_list" data-toggle="tooltip" title="Print">
                                                <i class="fa fa-print black"></i>
                                            </button>
                                            <button type="button" class="btn btn-default btn-report padding5" id="export_philhealth_list" data-toggle="tooltip" title="Export Excel">
...
$(document).ready(function(){   
    ...
    var process_philhealth_report_preview = function(){
        ...
        $.ajax({
            "dataType":"html",
            "type":"POST",
            "url":"Hris_Reports/reports/philhealth-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/preview",
            beforeSend : function(){
    ...
    var process_philhealth_report_print = function(){
        ...
        $.ajax({
            "dataType":"html",
            "type":"POST",
            "url":"Hris_Reports/reports/philhealth-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/print",
            beforeSend : function(){
    ...
    process_philhealth_report_preview();
    process_philhealth_report_print();
    ...
    $('#print_philhealth_list').click(function(event){
            showinitializeprint();
    ...
    $('#export_philhealth_list').on('click', function() {
        ...
        window.open("Hris_Reports/reports/export-philhealth-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"","_self");
    });

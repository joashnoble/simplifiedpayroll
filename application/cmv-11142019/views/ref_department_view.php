                                ...
                                <div class="panel-inside">
                                    <div class="panel-inside1">
                                            <div class="panel-heading emp-panel-header">
                                                <span id="emp-tbl-title">Department List</span>
                                                <button class="btn btn-default right_department_create" id="btn_new" style="float: right;margin-top: 8px;" title="Create New Department" >
                                                    <i class="fa fa-plus"></i> New
                                                </button>
                                            </div>
                                            <div class="panel-body table-responsive" style="padding-top:8px;">
                                                <table id="tbl_department" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr>
            ...
            <div class="modal-body">
                <center>
                    <p id="modal-body-message" style="font-size: 12pt!important;font-family: calibri;">
                            Remove <departmentname id="departmentname"></departmentname> Department?
                    </p>
                </center>
            </div>
...
<div id="modal_create_department" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static"><!--modal-->
<div class="modal-dialog modal-md">
    <div class="modal-content" style="border: 1px solid #81C784;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
            <h4 class="modal-title"><span id="modal_mode"> </span><i class="fa fa-home"></i> Department : <transaction class="transaction_type"></transaction></h4>
        </div>
        <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group" style="margin-bottom:0px;">
                    <label class="boldlabel"><span class="label-required">*</span> Department Name :</label>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_department').DataTable({
            "aLengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            "ajax" : "RefDepartment/transaction/list",
            "columns": [
                { targets:[0],data: "department" },
                { targets:[1],data: "description" },
                {
                    targets:[2],
                    render: function (data, type, full, meta){

                        return '<center>'+right_department_edit+right_department_delete+'</center>';
                    }
                }
            ],
            language: {
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_department tbody').on('click','button[name="edit_info"]',function(){
            _txnMode="edit";
            ...
            _selectedID=data.ref_department_id;
        ...
        $('#tbl_department tbody').on('click','button[name="remove_info"]',function(){
            _selectRowObj=$(this).closest('tr');
            var data=dt.row(_selectRowObj).data();
            _selectedID=data.ref_department_id;
            _department = data.department;
            $('#departmentname').text(_department);
            ...
            if(validateRequiredFields($('#frm_department'))){
                if(_txnMode==="new"){
                    createDepartment().done(function(response){
                        ...
                        $('#modal_create_department').modal('toggle');
                         $.unblockUI();
                    });
                    return;
                }
    ...
    var updateDepartment=function(){
        var _data=$('#frm_department').serializeArray();
        console.log(_data);
        _data.push({name : "ref_department_id" ,value : _selectedID});
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefDepartment/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
    ...
    var removeEmployee=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"RefDepartment/transaction/delete",
            "data":{ref_department_id : _selectedID}
        });
    };

                                ...
                                <div class="panel-inside">
                                    <div class="panel-inside1">
                                        <div class="panel-heading emp-panel-header">
                                             <h2 style="font-weight:300;">Employee Payroll Summary</h2>
                                             <span style="float: right;">
                                                <button type="button" class="btn btn-default btn-report padding5" id="print_emp_payroll_summary" title="Print">
                                                    <i class="fa fa-print"></i>
                                                </button>
                                                <button type="button" class="btn btn-default btn-report padding5" id="export_emp_payroll_summary" title="Export">
...
$(document).ready(function(){
    ...
    var process_preview_employee_payroll = function(){
        ...
        $.ajax({
            "dataType":"html",
            "type":"POST",
            "url":"PayrollHistory/layout/employee_payroll_summary/"+filter_pay_period+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/preview",
            beforeSend : function(){
    ...
    var process_print_employee_payroll = function(){
        ...
        $.ajax({
            "dataType":"html",
            "type":"POST",
            "url":"PayrollHistory/layout/employee_payroll_summary/"+filter_pay_period+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/print",
            beforeSend : function(){
  ...
  $('#export_emp_payroll_summary').on('click', function() {
        ...
        window.open("PayrollHistory/layout/export-employeee-payroll-summary/"+filter_pay_period+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"","_self");
    });

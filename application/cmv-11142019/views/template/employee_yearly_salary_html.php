<style>
	...
	<div style="font-size: 11pt; width: 100%;">
		<div class="temp_header">
			...
			<strong>
				Yearly Payroll Summary <br />
				Year : <?php echo $yearly;  ?> <br />
				Branch :
				<?php echo $get_branch; ?> <br />
				<hr><br />
			</strong>
		</div>
	</div>
...
<!-- 				<td align="center"><?php //echo number_format($row->coopcontribution_deduction,2); ?></td>
				...
				<td align="center"><?php
									echo number_format($row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$total_other_deductions,2);
									?></td>
				<td align="center"><?php
									echo number_format($row->gross_pay-($row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$total_other_deductions),2);
									?></td>
			</tr>
			<?php
				...
				$s_deductions += $row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$total_other_deductions;
	...
	<div style="font-size:9pt; margin-top: 10px;" class="summary">

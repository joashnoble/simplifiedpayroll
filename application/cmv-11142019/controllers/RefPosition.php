...
class RefPosition extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - Position Management';
    ...
    function transaction($txn = null) {
        switch ($txn) {
            case 'list':
                $response['data']=$this->RefPosition_model->get_position_list($this->session->company_id);
            ...
            case 'create':
                ...
                $m_position->company_id = $this->session->company_id;
                $m_position->save();

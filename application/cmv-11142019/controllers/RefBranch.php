...
class RefBranch extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - Branch Management';
    ...
    function transaction($txn = null) {
        switch ($txn) {
            case 'list':
                $response['data']=$this->RefBranch_model->get_branch_list($this->session->company_id);
            ...
            case 'create':
                ...
                $m_branch->company_id = $this->session->company_id;
                $m_branch->save();
            ...
            case 'delete':
                ...
                $response['data']=$this->RefBranch_model->checkifused($ref_branch_id);
                ...
                if($checkcount>0){
                    ...
                    $response['title']='Success!';
                    $response['stat']='success';
                    $response['msg']='Branch Reference successfully Deleted.';
            ...
            case 'update':
                ...
                $this->load->library('form_validation');
                $this->load->helper('security');
                $this->form_validation->set_rules('branch', 'Branch', 'strip_tags|xss_clean|required');  
                ...
                $m_branch->modified_by = $this->session->user_id;

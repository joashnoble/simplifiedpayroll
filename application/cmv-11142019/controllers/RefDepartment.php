...
class RefDepartment extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - Department Management';
    ...
    function transaction($txn = null) {
        switch ($txn) {
            case 'list':
                $response['data']=$this->RefDepartment_model->get_department_list($this->session->company_id);
            ...
            case 'create':
                ...
                $m_department->company_id = $this->session->company_id;
                $m_department->save();
            ...
            case 'createdirect':
                ...
                $m_department->description = $this->input->post('postdescription', TRUE);
                $m_department->date_created = date("Y-m-d H:i:s");
                $m_department->created_by = $this->session->user_id;
                $m_department->company_id = $this->session->company_id;
                $m_department->save();

...
class PagIbigReports extends CORE_Controller
{
    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_pagibigreport_view') == 0 || $this->session->userdata('right_pagibigreport_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - Pag-Ibig Report';
        $this->load->view('pag-ibig_reports_view', $data);
    }
}

...
class EmployeeDTRSummary extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_dtrsummary_view') == 0 || $this->session->userdata('right_dtrsummary_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - Employee DTR Summary';
        $this->load->view('employee_dtr_summary_view', $data);
    }
}

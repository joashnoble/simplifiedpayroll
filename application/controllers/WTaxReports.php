...
class WTaxReports extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_wtaxreport_view') == 0 || $this->session->userdata('right_wtaxreport_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - WTAX Report';
        $this->load->view('wtax_reports_view', $data);
    }
}

...
class RefSection extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'JCORE - Section Management';
    ...
    function transaction($txn = null) {
        switch ($txn) {
            case 'list':
                $response['data']=$this->RefSection_model->get_section_list($this->session->company_id);
            ...
            case 'create':
                ...
                $m_section->company_id = $this->session->company_id;
                $m_section->save();

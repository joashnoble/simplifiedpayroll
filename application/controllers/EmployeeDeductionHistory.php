...
class EmployeeDeductionHistory extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_employee_deduction_view') == 0 || $this->session->userdata('right_employee_deduction_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $this->load->view('employee_deduction_history_view', $data);
    }
}

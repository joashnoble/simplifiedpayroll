                                ...
                                <div class="panel-inside">
                                    <div class="panel-inside1">
                                            <div class="panel-heading emp-panel-header">
                                                <span id="emp-tbl-title">Branch List</span>
                                                <button class="btn btn-default right_branch_create" id="btn_new" style="float: right;margin-top: 8px;" title="Create New Branch" >
            ...
            <div class="modal-body">
                <center>
                    <p id="modal-body-message" style="font-size: 12pt!important;font-family: calibri;">
                            Remove <branchname id="branchname"></branchname> Branch?
                    </p>
                </center>
            </div>
...
<div id="modal_create_branch" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static"><!--modal-->
<div class="modal-dialog modal-md">
    <div class="modal-content" style="border: 1px solid #81C784;">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
            <h4 class="modal-title"><span id="modal_mode"> </span><i class="fa fa-home"></i> Branch : <transaction class="transaction_type"></transaction></h4>
        </div>
        <div class="modal-body">
            <form id="frm_branch">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group" style="margin-bottom:0px;">
                    <label class="boldlabel"><span class="label-required">*</span> Branch Name :</label>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_branch').DataTable({
            ...
            "columns": [
                { targets:[0],data: "branch" },
                { targets:[1],data: "description" },
                {
                    targets:[2],
                    render: function (data, type, full, meta){
                        return '<center>'+right_branch_edit+right_branch_delete+'</center>';
                    }
                }
            ],
            language: {

                                ...
                                <div class="panel-body table-responsive" style="padding-top:10px; margin-top: 10px;">
                                    <div style="margin-left: 20px;">
                                      <div class="row">
                                       ...
                                       <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_emp_payroll" style="background-color:#27ae60; color:white;width: 100px;margin-top: 15px;margin-left: 20px;"><i class="fa fa-print"></i> PRINT</button>
<!--                                             <button type="button" class="btn col-sm-12 btn-primary form-control" id="export_emp_payroll" style="color:white;margin-left: 20px;margin-top: 15px;width: auto;"><i class="fa fa-file-excel-o"></i> EXPORT EXCEL</button>    
                                            <button type="button" class="btn col-sm-12 btn-info form-control" id="email_emp_payroll" style="color:white;margin-left: 20px;margin-top: 15px; width: 100px;"><i class="fa fa-envelope"></i> EMAIL</button> -->
                                        </div>
                                    </div>
                                    <hr>
...
$(document).ready(function(){
  ...
  $('#export_emp_payroll').on('click', function() {
        ...
        window.open("PayrollHistory/layout/export-employeee-payroll-history/"+filter_employee+"/"+filter_pay_period+"/"+filter_branch+"","_self");
    });
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"PayrollHistory/layout/email-employeee-payroll-history/"+filter_employee+"/"+filter_pay_period+"/"+filter_branch+"",

...
<head>
    ...
    <style>
        ...
        #tbl_philhealth_contribution_list td{
                                    ...
                                    <div class="panel-inside1">
                                        ...
                                        <i class="fa fa-file"></i> New PhilHealth Contribution</button> -->
                                            <div class="panel-heading emp-panel-header">
                                                 <center><h2><img class="ph_logo" src="assets/img/logo/Philhealth.png"><b>Philhealth Contribution</b></h2></center>
                                            </div>
            ...
            <div class="modal-body">
                <center>
                    <p id="modal-body-message" style="font-size: 12pt!important;font-family: calibri;">
                            Remove Philhealth Contribution?
                    </p>
                </center>
            </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#ECEFF1;border-bottom: 5px solid #CFD8DC;">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:black;"><span id="modal_mode"> </span>PhilHealth Contribution : <transaction id="transaction"></transaction></h4>
                        </div>
    ...
    var initializeControls=function(){
        dt=$('#tbl_philhealth_contribution_list').DataTable({
            ...
            "columns": [
                ...
                //             return '<center>'+right_philhealth_edit+'</center>';
                //         }else{

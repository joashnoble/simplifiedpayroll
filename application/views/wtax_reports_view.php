                            ...
                            <div class="panel panel-default panel-padding">
                                <div class="panel-inside">
                                    ...
                                    <div class="panel-heading emp-panel-header">
                                            <h2 style="font-weight:300;">WTAX Report </h2>
                                            <span style="float: right;">
                                            <button type="button" class="btn btn-default btn-report padding5" id="print_wtax_list" data-toggle="tooltip" title="Print">
                                                <i class="fa fa-print black"></i>
                                            </button>
                                            <button type="button" class="btn btn-default btn-report padding5" id="export_wtax_list" data-toggle="tooltip" title="Export Excel">
                                    ...
                                    <div class="panel-body table-responsive" style="padding-top:10px; margin-top: 10px; background: #ECEFF1;">
                                            ...
                                            <div class="panel-footer white-bg" style="background: #FFF!important;">
...
$(document).ready(function(){
    ...
    var process_preview_wax_report = function(){
        ...
        filter_empstatus = $('#emp_status').val();
            ...
            "dataType":"html",
            "type":"POST",
            "url":"Hris_Reports/reports/wtax-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/preview",
    ...
    var process_print_wax_report = function(){
        ...
        filter_empstatus = $('#emp_status').val();
            ...
            "dataType":"html",
            "type":"POST",
            "url":"Hris_Reports/reports/wtax-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/print",
            beforeSend : showSpinningProgressLoading(),
                }).done(function(response){
                    $.unblockUI();
    ...
    process_preview_wax_report();
    process_print_wax_report(); 
    ...
    $('#export_wtax_list').on('click', function() {
        ...
        window.open("Hris_Reports/reports/export-wtax-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"","_self");
    });

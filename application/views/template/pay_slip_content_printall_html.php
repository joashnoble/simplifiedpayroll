...
<title>Simplified Payroll - Payslip</title>
<style type="text/css">
  #tbl_payslip_content { page-break-inside:auto }
  #tbl_payslip_content thead { display:table-header-group }
  #tbl_payslip_content tfoot { display:table-footer-group }
  #tbl_payslip_content{

                            ...
                            <div class="panel panel-default panel-padding">
                                <div class="panel-inside">
                                    ...
                                    <div class="panel-heading emp-panel-header">
                                         <h2 style="font-weight:300;">SSS Report </h2>
                                         <span style="float: right;">
                                            <button type="button" class="btn btn-default btn-report padding5" id="print_sss_list">
                                                <i class="fa fa-print"></i>
                                            </button>
                                            <button type="button" class="btn btn-default btn-report padding5" id="export_sss_list">
...
$(document).ready(function(){
    ...
    var process_preview_sss_report = function(){
        ...
        "dataType":"html",
        "type":"POST",
        "url":"Hris_Reports/reports/sss-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/preview",
    ...
    var process_print_sss_report = function(){
        ...
        "dataType":"html",
        "type":"POST",
        "url":"Hris_Reports/reports/sss-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/print",
        beforeSend : showSpinningProgressLoading(),
            }).done(function(response){
                $.unblockUI();
    ...
    process_preview_sss_report();
    process_print_sss_report();
    ...
    $('#export_sss_list').on('click', function() {
        ...
        window.open("Hris_Reports/reports/export-sss-list/"+filter_year+"/"+filter_month+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"","_self");
    });

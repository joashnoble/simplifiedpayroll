            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="EmployeeMonthlyPayrollSalary">Employee Monthly Payroll Salary</a></li>
                    </ol>
                        ...
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                     <center><h2 style="color:white;font-weight:300;">Employee Monthly Payroll Salary</h2></center>
                                </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-3">
                                              ...
                                              <select class="form-control" style="margin-left: 20px;" name="payperiod_filter" id="payperiod_filter" data-error-msg="Pay Period Filter is required" required>
                                                ...
                                                ?>
                                                <option value="1~<?php echo $minyear;?>">January~<?php echo $minyear;?></option>
                                                <option value="2~<?php echo $minyear;?>">February~<?php echo $minyear;?></option>
                                                <option value="3~<?php echo $minyear;?>">March~<?php echo $minyear;?></option>
                                                <option value="4~<?php echo $minyear;?>">April~<?php echo $minyear;?></option>
                                                <option value="5~<?php echo $minyear;?>">May~<?php echo $minyear;?></option>
                                                <option value="6~<?php echo $minyear;?>">June~<?php echo $minyear;?></option>
                                                <option value="7~<?php echo $minyear;?>">July~<?php echo $minyear;?></option>
                                                <option value="8~<?php echo $minyear;?>">August~<?php echo $minyear;?></option>
                                                <option value="9~<?php echo $minyear;?>">September~<?php echo $minyear;?></option>
                                                <option value="10~<?php echo $minyear;?>">October~<?php echo $minyear;?></option>
                                                <option value="11~<?php echo $minyear;?>">November~<?php echo $minyear;?></option>
                                                <option value="12~<?php echo $minyear;?>">December~<?php echo $minyear;?></option>
                                                <?php
                                                 $minyear++;
                                                }
                                                ?>
                                       ...
                                       <div class="row" style="margin-top: 10px;">
                                        <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_emp_monthly_salary" style="background-color:#27ae60; color:white;margin-left: 20px; width: 200px;">PRINT</button>
                                        </div>
                                    </div>
                                    <hr>
...
$(document).ready(function(){
    ...
    $('#payperiod_filter').val(d).trigger("change")
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"PayrollHistory/layout/employeee-monthly-salary/"+filter_employee+"/"+filter_pay_period+"/"+filter_branch+"",
        beforeSend : function(){
    ...
    $('#print_emp_monthly_salary').click(function(event){
            showinitializeprint();

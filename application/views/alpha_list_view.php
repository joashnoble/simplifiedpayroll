                                ...
                                <div class="panel-inside">
                                    <div class="panel-inside1">
                                        <div class="panel-heading emp-panel-header">
                                             <h2 style="font-weight:300;">Alpha List of Employee </h2>
                                             <span style="float: right;">
                                                <button type="button" class="btn btn-default btn-report padding5" id="print_alphalist">
                                                    <i class="fa fa-print"></i>
                                                </button>
                                                <button type="button" class="btn btn-default btn-report padding5" id="export-alphalist">
...
$(document).ready(function(){
    ...
    var process_preview_alphalist=function(){
        ...
        "dataType":"html",
        "type":"POST",
        "url":"PayrollReports/payrollreports/alpha_list/"+filter_year+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/preview",
        beforeSend : function(){
    ...
    var process_print_alphalist=function(){
        filter_year = $('#year_filter').val();
        filter_branch = $('#branch_filter').val();
        filter_department = $('#department_filter').val();
        filter_empstatus = $('#emp_status').val();
        ...
        "dataType":"html",
        "type":"POST",
        "url":"PayrollReports/payrollreports/alpha_list/"+filter_year+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"/print",
        beforeSend : function(){
    ...
    process_preview_alphalist();
    process_print_alphalist();
    ...
    $('#export-alphalist').click(function(){
        ...
        window.open("AlphaList/schedule/export-alphalist/"+filter_year+"/"+filter_branch+"/"+filter_department+"/"+filter_empstatus+"","_self");
    });

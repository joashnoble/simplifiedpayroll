                                ...
                                <div class="panel-inside">
                                    <div class="panel-inside1">
                                        ...
                                        <div class="panel-heading emp-panel-header">
                                             <h2 style="font-weight:300;">Employee Compensation History</h2>
                                             <span style="float: right;">
                                                <button type="button" class="btn btn-default btn-report padding5" id="print_employee_compensation" title="Print">
                                                    <i class="fa fa-print"></i>
                                                </button>
                                                <button type="button" class="btn btn-default btn-report padding5" id="export_employee_compensation" title="Export">
                                        ...
                                        <div class="panel-footer" style="background: #FFF;">
                                            <div id="preview_emp_compensation"></div>
                                            <div id="print_emp_compensation" style="display: none;"></div>
                                        </div>
                                    </div> <!--panel default -->
                                    </div>
                                </div>
...
$(document).ready(function(){
    ...
    var d = new Date();
    _datefilter=$("#payperiod_filter").select2({
    ...
    var process_preview_emp_compensation = function(){

    payperiod_filter = $('#payperiod_filter').val();
    employee_filter = $('#employee_filter').val();

    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"PayrollHistory/layout/employee-compensation/"+payperiod_filter+"/"+employee_filter+"/preview",
        beforeSend : function(){
                    $('#preview_emp_compensation').html("<center><img src='assets/img/loader/preloaderimg.gif'><h3>Loading...</h3></center>");
                },
            }).done(function(response){
                $('#preview_emp_compensation').html(response);
            });
    };

    var process_print_emp_compensation = function(){
    ...
    $.ajax({
        "dataType":"html",
        "type":"POST",
        "url":"PayrollHistory/layout/employee-compensation/"+payperiod_filter+"/"+employee_filter+"/print",
        beforeSend : function(){
                    $('#print_emp_compensation').html("<center><img src='assets/img/loader/preloaderimg.gif'><h3>Loading...</h3></center>");
                },
            }).done(function(response){
                $('#print_emp_compensation').html(response);
            });
    };

    $('#export_employee_compensation').on('click', function() {
        payperiod_filter = $('#payperiod_filter').val();
        employee_filter = $('#employee_filter').val();
        window.open("PayrollHistory/layout/export-employee-compensation/"+payperiod_filter+"/"+employee_filter+"","_self");
    });


    process_preview_emp_compensation();
    process_print_emp_compensation();
